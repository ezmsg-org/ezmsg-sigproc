...
and ``AxisArray.stream_dim`` is the producer's declaration of which dimension
...
class TestSpectrumPicksTheTransformAxis:
    ...
    def test_raw_input_still_transforms_time(self):
        ...
        assert out.stream_dim is None, "the transformed axis is consumed"


class TestFeatureStagesSkipTheStreamDim:
